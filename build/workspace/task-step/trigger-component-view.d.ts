...
export declare class TriggerComponentView implements ComponentView {
    g: SVGGElement;
    width: number;
    height: number;
    joinX: number;
    ...
    private constructor();
    static create(parent: SVGElement, step: TaskStep, configuration: StepsConfiguration): TriggerComponentView;
