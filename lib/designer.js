(function (global, factory) {
	...
	class SwitchStepComponentView {
	    ...
	    static create(parent, step, configuration) {
	        ...
	        Dom.attrs(moreIcon, {
	            class: "moreIcon",
	            x: ICON_SIZE$6 + containerWidths[0] + PADDING_X$5 + textWidth + 45,
	            y: PADDING_TOP * 1.2,
	            width: ICON_SIZE$6,
	            height: ICON_SIZE$6,
	        });
	...
	function addDropDown(dropdown, h, w, button, send, sub, cont) {
	    ...
	    dropdown.appendChild(gSubDropdownbox);
	    const rect1 = createRect("sqd-task-rect", // Temporary hidden 
	    0.5, h - 30, w, 4 * h + 5 * PADDING_Y, `dropdown${Date.now()}`, RECT_RADIUS);
