(function (global, factory) {
	...
	class ScrollBoxView$1 {
	    static create(parent, viewport) {
	        const root = Dom.element('div', {
	            class: 'sqd-scrollbox'
	        });
	        parent.appendChild(root);
	        const view = new ScrollBoxView$1(root, viewport);
	...
	***************************************************************************** */
	...
	class SwitchStepComponentView {
	    constructor(g, width, height, joinX, sequenceComponents, regionView, scrollboxView, validationErrorView) {
	        this.g = g;
	        this.width = width;
	        this.height = height;
	        this.joinX = joinX;
	    ...
	    static create(parent, step, configuration) {
	        ...
	        const scrollboxView = ScrollBoxView.create(dropdownPopBody2, gSubDropdownbox2Pop);
	        ...
	        return new SwitchStepComponentView(g, containersWidth, containerHeight, containerWidths[0], sequenceComponents, regionView, scrollboxView, validationErrorView);
	    }
	    getClientPosition() {
	...
	class ToolboxView {
	    static create(parent, context) {
	        ...
	        parent.appendChild(root);
	        const scrollboxView = ScrollBoxView$1.create(body, parent);
