	...
	class SwitchStepComponentView {
	    ...
	    static create(parent, step, configuration) {
	        ...
	        const text = Dom.svg("text", {
	            x: ICON_SIZE$6 + containerWidths[0] - PADDING_X$5 / 2 - 130,
	        ...
	        const boxWidth = ICON_SIZE$6 + 10 * PADDING_X$5 + 2 * textWidth;
	        const rect = Dom.svg("rect", {
	        ...
	        const textRight = Dom.svg("text", {
	            x: ICON_SIZE$6 + containerWidths[0] - PADDING_X$5 * 2,
	            y: boxHeight / 1.7 + PADDING_TOP,
	            class: "sqd-task-text",
	        });
	        ...
	        const rightCopyImgContainerCircle = Dom.svg("rect", {
	            ...
	            x: containerWidths[0] + 5 * PADDING_X$5 + 3 * ICON_SIZE$6 + 60,
	            y: PADDING_Y$5 + 10, // 
	        });
	        ...
	        Dom.attrs(icon1, {
	            ...
	            x: containerWidths[0] + 5 * PADDING_X$5 + 3 * ICON_SIZE$6 + 63,
	            y: PADDING_Y$5 + 14,
	            width: ICON_SIZE$6,
	            height: ICON_SIZE$6,
	        });
	        ...
	        const rightDeleteImgContainerCircle = Dom.svg("rect", {
	            class: "sqd-task-ImgContainerCircle",
	            x: containerWidths[0] + 5 * PADDING_X$5 + 3 * ICON_SIZE$6 + 40,
	            y: PADDING_Y$5 + 40,
	        });
	        ...
	        Dom.attrs(icon2, {
	            ...
	            x: containerWidths[0] + 5 * PADDING_X$5 + 3 * ICON_SIZE$6 + 43,
	            y: PADDING_Y$5 + 43,
	            width: 22,
	            height: 22,
	        });
	        ...
	        const checkImgContainerCircle = Dom.svg("rect", {
	            class: "sqd-task-ImgContainerCircle",
	            x: ICON_SIZE$6 + textWidth / 2 + 2 * PADDING_X$5 + 239,
	            y: PADDING_Y$5 - 30,
	        });
	        ...
	        Dom.attrs(icon3, {
	            class: "moreicon",
	            // id: `tagUpCheckIcon`,
	            x: ICON_SIZE$6 + textWidth / 2 + 2 * PADDING_X$5 + 243,
	            y: PADDING_Y$5 - 26,
	            width: 22,
	            height: 22,
	        });
	        ...
	        const deleteImgContainerCircle = Dom.svg("rect", {
	            class: "sqd-task-ImgContainerCircle",
	            x: ICON_SIZE$6 + textWidth / 2 + 2 * PADDING_X$5 + 309,
	            y: PADDING_Y$5 - 30,
	        });
	        ...
	        Dom.attrs(upDeleteIcon, {
	            ...
	            x: ICON_SIZE$6 + textWidth / 2 + 2 * PADDING_X$5 + 313,
	            y: PADDING_Y$5 - 26,
	            width: ICON_SIZE$6,
	            height: ICON_SIZE$6,
	        });
	        ...
	        const copyImgContainerCircle = Dom.svg("rect", {
	            class: "sqd-task-ImgContainerCircle",
	            x: ICON_SIZE$6 + textWidth / 2 + 2 * PADDING_X$5 + 274,
	            y: PADDING_Y$5 - 30,
	        });
	        ...
	        Dom.attrs(upchangeIcon, {
	            ...
	            x: ICON_SIZE$6 + textWidth / 2 + 2 * PADDING_X$5 + 278,
	            y: PADDING_Y$5 - 26,
	            width: ICON_SIZE$6,
	            height: ICON_SIZE$6,
	        });
	        ...
	        Dom.attrs(reminder1, {
	            ...
	            x: containerWidths[0] + 5 * PADDING_X$5 + 3 * ICON_SIZE$6 + 77,
	            y: PADDING_Y$5 - 18, // -25 -> -8
	        });
	        const reminderText1 = Dom.svg("text", {
	            class: "sqd-task-text",
	            x: containerWidths[0] + 5 * PADDING_X$5 + 3 * ICON_SIZE$6 + 77 + 13,
	            y: PADDING_Y$5 - 6,
	        });
	        ...
	        Dom.attrs(reminder2, {
	            ...
	            x: containerWidths[0] + 5 * PADDING_X$5 + 3 * ICON_SIZE$6 + 97,
	            y: PADDING_Y$5 + 13,
	        });
	        const reminderText2 = Dom.svg("text", {
	            class: "sqd-task-text",
	            x: containerWidths[0] + 5 * PADDING_X$5 + 3 * ICON_SIZE$6 + 97 + 10,
	            y: PADDING_Y$5 + 13 + 12,
	        });
	        ...
	        const reminderText3 = Dom.svg("text", {
	            class: "sqd-task-text",
	            x: containerWidths[0] + 5 * PADDING_X$5 + 3 * ICON_SIZE$6 + 77 + 6,
	            y: PADDING_Y$5 + 43 + 12,
	        });
	...
	class TriggerComponentView {
	    ...
	    static create(parent, step, configuration) {
	        ...
	        const textRight = Dom.svg("text", {
	            ...
	            x: (textWidth / MIN_TEXT_WIDTH$4) * 48.5 + MIN_TEXT_WIDTH$4,
	            y: boxHeight / 1.7 + 1,
	        ...
	        const dropdownBoxShape = Dom.svg("rect", {
	            ...
	            rx: "4",
	            ry: "4",
	            x: ICON_SIZE$5 + 5 * PADDING_X$4 + 17,
	            y: 1.2 * boxHeight + 15,
	        });
	        const dropdownBoxShape1 = Dom.svg("rect", {
	            width: 100,
	        ...
	        const dropdownBoxInnerText = Dom.svg("text", {
	            class: "sqd-task-text",
	            x: ICON_SIZE$5 + 5 * PADDING_X$4 + 25,
	            y: 1.4 * boxHeight + 18,
	        });
	        ...
	        const modifyDropdown = function (list) {
	            ...
	            for (let i = 1; i <= list.length; i++) {
	                ...
	                const dropdownBoxBottomShapecover = Dom.svg("rect", {
	                    ...
	                    fill: "#fff",
	                    stroke: "none",
	                    x: ICON_SIZE$5 + 5 * PADDING_X$4 + 22,
