(function (global, factory) {
	...
	class SwitchStepComponentView {
	    ...
	    static create(parent, step, configuration) {
	        ...
	        const boxHeight = ICON_SIZE$6 + PADDING_Y$5 * 2;
	        ...
	        g1.appendChild(text);
	        const textWidth = Math.max(text.getBBox().width + PADDING_X$5 * 2 + ICON_SIZE$6, MIN_TEXT_WIDTH$5);
	        const boxWidth = ICON_SIZE$6 + PADDING_X$5 * 3 + textWidth;
	        const rect = Dom.svg("rect", {
	        ...
	        Dom.attrs(icon, {
	            x: containerWidths[0] - textWidth + PADDING_X$5,
	            y: PADDING_TOP * 1.5,
	            width: ICON_SIZE$6,
	            height: ICON_SIZE$6,
	        });
	        ...
	        Dom.attrs(moreIcon, {
	            class: "more",
	            id: Date.now(),
	            x: containerWidths[0] + 2 * PADDING_X$5,
	            y: PADDING_TOP * 1.5,
	            width: ICON_SIZE$6,
	            height: ICON_SIZE$6,
	        });
	        ...
	        Dom.attrs(icon1, {
	            ...
	            x: containerWidths[0] + 2 * PADDING_X$5 + ICON_SIZE$6 + 30,
	            y: PADDING_TOP * 1.5,
	            width: ICON_SIZE$6,
	            height: ICON_SIZE$6,
	        });
	        ...
	        Dom.attrs(icon2, {
	            ...
	            x: containerWidths[0] + 2 * PADDING_X$5 + ICON_SIZE$6 + 10,
