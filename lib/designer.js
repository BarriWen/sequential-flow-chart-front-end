(function (global, factory) {
	...
	class SequenceComponentView {
	    ...
	    static create(parent, sequence, configuration) {
	        ...
	        const components = sequence.map((s) => StepComponentFactory.create(gGroup, s, sequence, configuration));
	...
	class SwitchStepComponentView {
	    ...
	    static create(parent, step, configuration) {
	        ...
	        const checkImgContainerCircle = Dom.svg("rect", {
	            class: "sqd-task-ImgContainerCircle",
	            x: containerWidths[0] + 5 * PADDING_X$5 + 3 * ICON_SIZE$6 - 56,
	            y: PADDING_Y$5 - 30,
	        });
	        ...
	        Dom.attrs(icon3, {
	            class: "moreicon",
	            // id: `tagUpCheckIcon`,
	            x: containerWidths[0] + 5 * PADDING_X$5 + 3 * ICON_SIZE$6 - 52,
	            y: PADDING_Y$5 - 26,
	            width: 22,
	            height: 22,
	        });
	        ...
	        const deleteImgContainerCircle = Dom.svg("rect", {
	            class: "sqd-task-ImgContainerCircle",
	            x: containerWidths[0] + 5 * PADDING_X$5 + 3 * ICON_SIZE$6 + 14,
	            y: PADDING_Y$5 - 30,
	        });
	        ...
	        Dom.attrs(upDeleteIcon, {
	            ...
	            x: containerWidths[0] + 5 * PADDING_X$5 + 3 * ICON_SIZE$6 + 18,
	            y: PADDING_Y$5 - 26,
	            width: ICON_SIZE$6,
	            height: ICON_SIZE$6,
	        });
	        ...
	        const copyImgContainerCircle = Dom.svg("rect", {
	            class: "sqd-task-ImgContainerCircle",
	            x: containerWidths[0] + 5 * PADDING_X$5 + 3 * ICON_SIZE$6 - 21,
	            y: PADDING_Y$5 - 30,
	        });
	        ...
	        Dom.attrs(upchangeIcon, {
	            ...
	            x: containerWidths[0] + 5 * PADDING_X$5 + 3 * ICON_SIZE$6 - 17,
	            y: PADDING_Y$5 - 26,
	            width: ICON_SIZE$6,
	            height: ICON_SIZE$6,
	        });
