(function (global, factory) {
	...
	class SwitchStepComponentView {
	    static create(parent, step, configuration) {
	        ...
	        const boxHeight = ICON_SIZE$6 + PADDING_Y$5;
	        ...
	        Dom.attrs(moreIcon, {
	            class: "more",
	            id: Date.now(),
	            x: ICON_SIZE$6 + containerWidths[0] + PADDING_X$5 + textWidth,
	            y: PADDING_TOP * 1.2,
	            width: ICON_SIZE$6,
	            height: ICON_SIZE$6,
	        });
	        ...
	        const icon1 = Dom.svg("image", { href: iconUrl1 })
	            ;
	        Dom.attrs(icon1, {
	            class: "moreicon",
	            id: `RightCopyIcon-${step.id}`,
	            x: containerWidths[0] + 5 * PADDING_X$5 + 3 * ICON_SIZE$6 + 30,
	            y: PADDING_TOP * 1.5,
	            width: ICON_SIZE$6,
	            height: ICON_SIZE$6,
	        });
	        ...
	        Dom.attrs(icon2, {
	            ...
	            x: containerWidths[0] + 5 * PADDING_X$5 + 3 * ICON_SIZE$6 + 10,
	...
	***************************************************************************** */
	...
	class EmailComponentView {
	    ...
	    static create(parent, step, configuration) {
	        ...
	        const moreUrl = "./assets/moreEmail.svg";
	        const moreIcon = Dom.svg("image", {
	                href: moreUrl,
	            })
	            ;
	        ...
	        const gmoreIcon = Dom.svg("g", {
	            class: 'sqd-task-group-email-moreicon'
	        });
	        gmoreIcon.appendChild(moreIcon);
	        gmoreIcon.appendChild(moreIconDot);
	        g.appendChild(gmoreIcon);
	...
	function addDropDown(dropdown, h, w, button, send, sub, addr, cont) {
	    ...
	    gSubDropdownbox.appendChild(txtIcon);
	    ...
	    const htmlText = Dom.svg("text", {
	        x: 177,
	        y: 267,
	        class: "email-html-text"
	    });
	    htmlText.textContent = "HTML";
	    gSubDropdownbox.appendChild(htmlText);
