	...
	class SwitchStepComponentView {
	    ...
	    static create(parent, step, configuration) {
	        ...
	        const rightCopyImgContainerCircle = Dom.svg("rect", {
	            ...
	            x: ICON_SIZE$6 + 4 * PADDING_X$5 + 2 * textWidth + 112,
	            y: PADDING_Y$5 + 10, // 
	        });
	        ...
	        Dom.attrs(icon1, {
	            ...
	            x: ICON_SIZE$6 + 4 * PADDING_X$5 + 2 * textWidth + 116,
	            y: PADDING_Y$5 + 14,
	            width: ICON_SIZE$6,
	            height: ICON_SIZE$6,
	        });
	        ...
	        const rightDeleteImgContainerCircle = Dom.svg("rect", {
	            class: "sqd-task-ImgContainerCircle",
	            x: ICON_SIZE$6 + 4 * PADDING_X$5 + 2 * textWidth + 92,
	            y: PADDING_Y$5 + 40,
	        });
	        ...
	        Dom.attrs(icon2, {
	            ...
	            x: ICON_SIZE$6 + 4 * PADDING_X$5 + 2 * textWidth + 95,
	            y: PADDING_Y$5 + 43,
	            width: 22,
	            height: 22,
	        });
	        ...
	        const reminderText1 = Dom.svg("text", {
	            class: "sqd-task-text",
	            x: ICON_SIZE$6 + 4 * PADDING_X$5 + 2 * textWidth + 132 + 13,
	            y: PADDING_Y$5 - 6,
	        });
	        ...
	        Dom.attrs(reminder2, {
	            ...
	            x: ICON_SIZE$6 + 4 * PADDING_X$5 + 2 * textWidth + 152,
	            y: PADDING_Y$5 + 13,
	        });
	        const reminderText2 = Dom.svg("text", {
	            class: "sqd-task-text",
	            x: ICON_SIZE$6 + 4 * PADDING_X$5 + 2 * textWidth + 152 + 8,
	            y: PADDING_Y$5 + 13 + 12,
	        });
	        ...
	        const reminderText3 = Dom.svg("text", {
	            class: "sqd-task-text",
	            x: ICON_SIZE$6 + 4 * PADDING_X$5 + 2 * textWidth + 140,
	            y: PADDING_Y$5 + 43 + 12,
	        });
