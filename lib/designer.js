	...
	***************************************************************************** */
	...
	class TimeTriggerTaskStepComponentView {
	    ...
	    static create(parent, step, configuration) {
	        ...
	        const textRight = Dom.svg("text", {
	            x: ICON_SIZE$2 + 3 * PADDING_X$1 + textWidth - 6,
	            y: boxHeight / 1.7 - 2,
	            class: "sqd-task-text",
	        });
	        ...
	        var divTimeTriggerRecurring = document.createElementNS("http://www.w3.org/1999/xhtml", "div");
	        var divTimeTriggerCalender = document.createElementNS("http://www.w3.org/1999/xhtml", "div");
	        ...
	        divTimeTriggerRecurring.setAttribute("class", "divTimeTriggerRecurring");
	        divTimeTriggerCalender.setAttribute("class", "divTimeTriggerCalender");
	        divTimeTriggerCalender.setAttribute("id", "calender");
	        //divTagWaitTime.setAttribute("class", "sqd-hidden");
	        var collection = document.createElement("Form");
	        ...
	        getlist();
	        const pulltheList = function (list) {
