(function (global, factory) {
	...
	***************************************************************************** */
	...
	class SwitchStepComponentView {
	    constructor(g, width, height, joinX, sequenceComponents, regionView, scrollboxViewCountry, scrollboxViewLocation, scrollBoxViewState, validationErrorView) {
	        this.g = g;
	        this.width = width;
	        this.height = height;
	        this.joinX = joinX;
	    ...
	    static create(parent, step, configuration) {
	        ...
	        // Emptied bug?
	        const sequenceComponents = branchNames.map((bn) => SequenceComponent.create(g, step.branches[bn], configuration), console.log("sequenceComponents"));
	        ...
	        for (let i = 1; i <= contInfo.length; i++) {
	            ...
	            dropdownBoxBottomShapecoverMain1.addEventListener("click", function (e) {
	                ...
	                else if (choice1 == "Email Address" || choice1 == "Full Name"
