(function (global, factory) {
	...
	class DesignerContext {
	    constructor(definition, behaviorController, layoutController, configuration, isToolboxCollapsed, isSmartEditorCollapsed) {
	        ...
	        this.onZoomChanged = new SimpleEvent();
	        this.viewPort = {
	...
	class ControlBarView {
	    static create(parent) {
	        ...
	        const zoomInButton = createButton$1(Icons.zoomIn, 'Zoom in');
	        const zoomPercentageElement = Dom.element('div', {
	            class: 'zoom-percentage'
	        });
	        const zoomOutButton = createButton$1(Icons.zoomOut, 'Zoom out');
	    ...
	    zoomInButton, zoomPercentageElement, zoomOutButton) {
	        this.zoomInButton = zoomInButton;
	        this.zoomPercentageElement = zoomPercentageElement;
	    ...
	    bindZoomInButtonClick(handler) {
	        bindClick$1(this.zoomInButton, handler);
	    }
	    bindZoomOutButtonClick(handler) {
	        bindClick$1(this.zoomOutButton, handler);
	    }
	    setZoomPercentage(percentage) {
	        this.zoomPercentageElement.textContent = Math.round(percentage * 100) + '%';
	    }
	}
	function bindClick$1(element, handler) {
	    element.addEventListener('click', e => {
	        e.preventDefault();
	        handler();
	    }, false);
	}
	function createButton$1(iconContent, title) {
	...
	class ControlBar {
	    static create(parent, context) {
	        ...
	        context.onZoomChanged.subscribe((newScale) => {
	...
	***************************************************************************** */
	...
	class SwitchStepComponentView {
	    constructor(g, width, height, joinX, sequenceComponents, regionView, scrollboxViewCountry, scrollboxViewLocation, scrollBoxViewState, validationErrorView // public readonly icon1: SVGElement, // public readonly icon2: SVGElement, // public readonly icon3: SVGElement
	    ) {
	        this.g = g;
	        this.width = width;
	        this.height = height;
	        ...
	        this.scrollBoxViewState = scrollBoxViewState;
	    ...
	    static create(parent, step, configuration) {
	        ...
	        const hint_mark = Dom.svg("image", {
	            x: ICON_SIZE$6 + containerWidths[0] - 11,
	            y: boxHeight / 2.0 - 12,
	            width: 12,
	            height: 12,
	        ...
	        const hint_text = Dom.svg("text", {
	            // class: "sqd-task-text",
	            x: ICON_SIZE$6 + containerWidths[0] + 2,
	            y: boxHeight / 2.0 - 2,
	            fill: "#F00000",
	            "font-size": "11px",
	        });
	        ...
	        branchNames.forEach((branchName, i) => {
	            ...
	            LabelView.create(g, offsetX + joinXs[i] + PADDING_X$5, PADDING_TOP + LABEL_HEIGHT + CONNECTION_HEIGHT + boxHeight / 2, labelNames[i], "secondary");
	        ...
	        const textRight = Dom.svg("text", {
	            x: ICON_SIZE$6 + containerWidths[0] - PADDING_X$5 * 5,
	            ...
	            dropdownBoxBottomShapecoverMain1.addEventListener("click", function (e) {
	                ...
	                if (choice1 == "Birthday") {
	                    ...
	                    textInput.addEventListener("input", function (e) {
	                        ...
	                        else if (textInput.value.match(errFormat) ||
	                ...
	                for (let i = 1; i <= list2.length; i++) {
	                    ...
	                    dropdownBoxBottomShape1cover.addEventListener("click", function (e) {
	                        ...
	                        if (choice2 == "Is Blank" || choice2 == "Blank") {
	                            ...
	                            inputArea.classList.add("sqd-hidden");
	                            gSubDropdown2.classList.add("sqd-hidden");
	                            dropdownBoxShape1.setAttribute("x", (DROPDOWN_X2 + 125).toString());
	                            dropdownRightButtonDown1.setAttribute("x", (DROPDOWN_X2 + DROPDOWN2_W + 105).toString());
	                            dropdownRightButtonUp1.setAttribute("x", (DROPDOWN_X2 + DROPDOWN2_W + 105).toString());
	                            dropdownBoxInnerText1.setAttribute("x", (DROPDOWN_X2 + 128).toString());
	                            dropdownBoxShapeAfter1.setAttribute("x", (DROPDOWN_X2 + 125).toString());
	                            actConditonText.classList.add("sqd-hidden");
	                            dropdownBoxBottomShape1.setAttribute("x", (DROPDOWN_X2 + 125).toString());
	                        ...
	                        else if (choice2 == "Is In US State" ||
	                        ...
	                        for (let i = 1; i <= list3.length; i++) {
	                            ...
	                            dropdownBoxBottomShape2cover.addEventListener("click", function (e) {
	                                ...
	                                if ((choice2 == "Is Within" || choice2 == "Is Not Within") &&
	                                    ...
	                                    vPrompt.setAttribute("y", (DROPDOWN_Y + DROPDOWN_H + 53).toString());
	        ...
	        for (let i = 1; i <= actions.length; i++) {
	            ...
	            dropdownBoxBottomShapecoverMain2.addEventListener("click", function (e) {
	                ...
	                if (choice1 == "Opened" ||
	                    ...
	                    choice1 == "Clicked" ||
	                    choice1 == "Not Clicked") {
	                    if (!dropdownBoxInnerTextAct1.textContent ||
	        ...
	        let champaingns = ["default"];
	        // Async way to fetch tags
	        const getChampaingns = () => __awaiter(this, void 0, void 0, function* () {
	            ...
	            for (let i = 1; i <= champaingns.length; i++) {
	                ...
	                dropdownBoxBottomShapeAct2cover.addEventListener("click", function (e) {
	                    ...
	                    actTextInput.addEventListener("input", function (e) {
	                        ...
	                        else if (!/^\d+(\.\d+)?$/.test(actTextInput.value) ||
	        ...
	        gSubDropdownAct1.insertBefore(dropdownBoxShapeAct1, dropdownRightButtonDownAct1);
	        gSubDropdownAct2.insertBefore(dropdownBoxShapeAct2, dropdownRightButtonDownAct2);
	        gSubDropdownMain1.insertBefore(dropdownBoxShapeMain1, dropdownRightButtonDownMain1);
	        gSubDropdownMain2.insertBefore(dropdownBoxShapeMain2, dropdownRightButtonDownMain2);
	        // Inner text
	        ...
	        editIcon.addEventListener("click", function (e) {
	            ...
	            gRightPop3.classList.toggle("sqd-hidden");
	            if (step.properties["type"] == "Contact Info" ||
	        ...
	        upCheckIcon.addEventListener("click", function (e) {
	            ...
	            if (dropdownBoxInnerText.textContent &&
	                dropdownBoxInnerText.textContent != "Select a condition") {
	            ...
	            else if (step.properties["type"] == "Actions" &&
	                dropdownBoxInnerTextAct1.textContent &&
	                dropdownBoxInnerTextAct1.textContent != "") {
	        ...
	        const scrollBoxViewState = ScrollBoxViewState.create(dropdownPopBody3, gSubDropdownbox2Pop);
	        ...
	        if ((step.properties["value"] != "" ||
	            ...
	            step.properties["type"] == "Contact Info") {
	            let Main1Button = document.getElementById(`dropdownBoxShapeAfterMain1${step.id}`);
	            let prevMain1 = document.getElementById(`dropdownBoxBottomShapecoverMain1${step.properties["property"]}${step.id}`);
	            ...
	            if (choice1 == "Gender") {
	                let prevDp2 = document.getElementById(`dropdownBoxBottomShape2cover${step.properties["value"]}${step.id}`);
	                if (prevDp2) {
	            ...
	            if (step.properties["condition"] != "Is") {
	                let prevDp1 = document.getElementById(`dropdownBoxBottomShape1cover${step.properties["condition"]}${step.id}`);
	                if (prevDp1) {
	            ...
	            if (choice1 == "Location" &&
	                ...
	                let loc = parts[1];
	                let prevDp2 = document.getElementById(`dropdownBoxBottomShape2cover${distance}${step.id}`);
	                if (prevDp2) {
	                    prevDp2.dispatchEvent(fakeClick);
	                    prevDp2.dispatchEvent(fakeClick);
	        ...
	        else if (step.properties["value"] != "" &&
	            step.properties["type"] == "Action") {
	            let parts = step.properties["value"].toString().split(" ");
	            let num = parts[0];
	            let time = parts[1];
	            actTextInput.value = num;
	            let Main2Button = document.getElementById(`dropdownBoxShapeAfterMain2${step.id}`);
	            let prevMain2 = document.getElementById(`dropdownBoxBottomShapecoverMain2${step.properties["property"]}${step.id}`);
	            let prevActDp1 = document.getElementById(`dropdownBoxBottomShapeAct2cover${step.properties["condition"]}${step.id}`);
	            let prevActDp2 = document.getElementById(`dropdownBoxBottomShape2cover${time}${step.id}`);
	        ...
	        return new SwitchStepComponentView(g, containersWidth, containerHeight, containerWidths[0], sequenceComponents, regionView, scrollboxViewCountry, scrollboxViewLocation, scrollBoxViewState, validationErrorView);
	    }
	    getClientPosition() {
	...
	class TimeDelayTaskStepComponentView {
	    ...
	    static create(parent, step, configuration) {
	        ...
	        hint_text.textContent = "Please set up your time delay";
	...
	function tagDropDown(dropdown, h, w, temp, step) {
	    const gSubDropdownbox = Dom.svg("g", {
	...
	let tagSelected;
	let operationSelected = "tag";
	function addNewTag(parent, h, w, upCheckBtn, newTag) {
	    const g = Dom.svg("g", {
	        class: `create-tag`,
	    });
	    ...
	    // Text wrapper
	    const rect = createRect$1("create-tag", createTagText.getBBox().x - 8, createTagText.getBBox().y + 28, createTagText.getBBox().width, createTagText.getBBox().height, `newTag${Date.now()}`);
	...
	function addDropDown(dropdown, h, w, button, send, sub, addr, cont) {
	    ...
	    const classicDesignWrapper = createRect("content-option", startX, startY + height + PADDING_Y / 2, 65, 60, "", RECT_RADIUS);
	    const classicDesignIcon = Dom.svg("image", {
	        href: "../assets/classic.svg",
	        width: 60,
	        height: 60,
	        class: "option select-field",
	        x: startX - PADDING_X / 2 + 10,
	    ...
	    const textInput = Dom.element("input", {
	        class: "email-text-input email-field sqd-hidden",
	        name: "subject",
	        type: "text",
	        placeholder: "text"
	    });
	    ...
	    button.addEventListener("click", function (e) {
	        ...
	        else if (addressInput.value.includes('@')) { // No domain part
	...
	class Workspace {
	    ...
	    onIsDraggingChanged(isDragging) {
	        ...
	        document.querySelectorAll(".encapsulated");
	...
	class rbButtonsBoxView {
	    ...
	    constructor(rbButton1, rbButton2) {
	        this.rbButton1 = rbButton1;
	        this.rbButton2 = rbButton2;
	    }
	    bindRbButton1Click(handler) {
	        bindClick(this.rbButton1, handler);
	    }
	    bindRbButton2Click(handler) {
	...
	function createButton(bgPath, mainPath, title) {
